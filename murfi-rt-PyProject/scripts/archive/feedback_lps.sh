...
clear
    ...
    export MURFI_SUBJECT_NAME=$subj 
    #scanner setup
    singularity exec -B /BOLD_DICOM:/BOLD_DICOM /home/rt-mgh/murfi-sif_latest.sif murfi -f $subj_dir/xml/rtdmn.xml
   #simulator
...
clear
    ...
    export MURFI_SUBJECTS_DIR="${absolute_path}/subjects/"
    export MURFI_SUBJECT_NAME=$subj
    singularity exec -B /BOLD_DICOM:/BOLD_DICOM /home/rt-mgh/murfi-sif_latest.sif murfi -f $subj_dir/xml/rest.xml
